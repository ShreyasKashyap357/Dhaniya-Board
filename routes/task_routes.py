...
from controllers.task_controllers import create_task, update_task, delete_task, update_task_status, get_project_tasks, add_project_column
...
@task_bp.route('/api/projects/<uuid:project_id>/columns', methods=['POST'])
def add_column(project_id):
    return add_project_column(project_id)